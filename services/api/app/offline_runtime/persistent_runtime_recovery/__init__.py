"""persistent_runtime_recovery — persistência operacional (stub v2)."""
...
def persistent_runtime_recovery_stub(rid: str) -> dict[str, Any]:
    base = judge_mobile_core_payload(
        replay_summary={"layer": "persistent_runtime_recovery", "runtime": "offline_runtime", "rid": rid},
        sync_hints=["Checkpoint antes de merge; replay-first."],
        deterministic_alignment={"token": "o-persistent_runtime_recovery"},
