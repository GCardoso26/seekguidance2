"""persistent_semantic_cache — persistência operacional (stub v2)."""
...
def persistent_semantic_cache_stub(rid: str) -> dict[str, Any]:
    base = judge_mobile_core_payload(
        replay_summary={"layer": "persistent_semantic_cache", "runtime": "offline_runtime", "rid": rid},
        sync_hints=["Checkpoint antes de merge; replay-first."],
        deterministic_alignment={"token": "o-persistent_semantic_cache"},
    ...
    return attach_persistent_operational_fields(
        base,
        persistent_status={"wal": True, "pkg": "persistent_semantic_cache"},
