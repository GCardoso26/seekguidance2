...
def mobile_sync_resilience_v2_stub(device_id: str) -> dict[str, Any]:
    return {
        "device_id": device_id,
        "assistant_notes": ["mobile_sync_resilience_v2_stub: estabilidade v2; explainability-first."],
