...
def mobile_runtime_consensus_v2_stub(device_id: str) -> dict[str, Any]:
    return {
        "device_id": device_id,
        "assistant_notes": ["mobile_runtime_consensus_v2_stub: estabilidade v2; explainability-first."],
