"""deterministic_replay_hashing — reconciliação real de replay (stub operacional)."""
...
def deterministic_replay_hashing_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "deterministic_replay_hashing", "status": "reconciled_stub"},
        "lineage_replay_awareness": {"slice": f"dete-{replay_id}"},
    }
