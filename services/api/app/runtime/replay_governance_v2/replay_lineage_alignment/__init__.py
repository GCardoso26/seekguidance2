"""replay_lineage_alignment — reconciliação real de replay (stub operacional)."""
...
def replay_lineage_alignment_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "replay_lineage_alignment", "status": "reconciled_stub"},
