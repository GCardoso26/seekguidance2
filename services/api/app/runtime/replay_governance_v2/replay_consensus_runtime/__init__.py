"""replay_consensus_runtime — reconciliação real de replay (stub operacional)."""
...
def replay_consensus_runtime_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "replay_consensus_runtime", "status": "reconciled_stub"},
