"""cross_device_replay_merge — reconciliação real de replay (stub operacional)."""
...
def cross_device_replay_merge_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "cross_device_replay_merge", "status": "reconciled_stub"},
        "lineage_replay_awareness": {"slice": f"cros-{replay_id}"},
    }
