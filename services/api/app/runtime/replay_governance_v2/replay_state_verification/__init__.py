"""replay_state_verification — reconciliação real de replay (stub operacional)."""
...
def replay_state_verification_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "replay_state_verification", "status": "reconciled_stub"},
