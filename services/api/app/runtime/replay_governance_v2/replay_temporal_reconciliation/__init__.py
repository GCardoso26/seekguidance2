"""replay_temporal_reconciliation — reconciliação real de replay (stub operacional)."""
...
def replay_temporal_reconciliation_stub(replay_id: str) -> dict[str, Any]:
    return {
        "replay_id": replay_id,
        "assistant_notes": [
        ...
        "replay_summary": {"layer": "replay_temporal_reconciliation", "status": "reconciled_stub"},
