"""replay_runtime_index — contrato incremental (sem DB pesado)."""
...
def replay_runtime_index_upsert_stub(
    replay_ref: str,
    *,
    ...
    return {
        ...
        "assistant_notes": [
            "replay_runtime_index: explainability-first; reasoning_v1…v11 inalterados no núcleo.",
            "Soft normalization apenas; sem equivalência forte cross-TCG.",
        ],
        "legality_reasoning": {"status": "assistant_stub", "layer": "replay_runtime_index"},
        "replay_reasoning": {"deterministic_resume": True, "layer": "replay_runtime_index"},
