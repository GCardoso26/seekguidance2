...
def replay_snapshot_rotation_stub(replay_ref: str) -> dict[str, Any]:
    return {
        "replay_ref": replay_ref,
        "assistant_notes": ["replay_snapshot_rotation_stub: execução operacional; explainability-first."],
