"""replay_integrity_service — wiring operacional sobre repositórios existentes (sem DB pesado)."""
...
def replay_integrity_service_stub(replay_ref: str) -> dict[str, Any]:
