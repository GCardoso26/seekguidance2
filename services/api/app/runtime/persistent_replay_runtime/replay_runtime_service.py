"""replay_runtime_service — wiring operacional sobre repositórios existentes (sem DB pesado)."""
...
def replay_runtime_service_stub(replay_ref: str) -> dict[str, Any]:
