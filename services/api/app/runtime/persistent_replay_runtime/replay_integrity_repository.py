"""replay_integrity_repository — contrato incremental (sem DB pesado)."""
...
def replay_integrity_record_stub(
    replay_ref: str,
    *,
    ...
    return {
        ...
        "assistant_notes": [
            "replay_integrity_repository: explainability-first; reasoning_v1…v11 inalterados no núcleo.",
            "Soft normalization apenas; sem equivalência forte cross-TCG.",
        ],
        "legality_reasoning": {"status": "assistant_stub", "layer": "replay_integrity_repository"},
        "replay_reasoning": {"deterministic_resume": True, "layer": "replay_integrity_repository"},
