"""replay_branch_archive — contrato incremental (sem DB pesado)."""
...
def replay_branch_archive_stub(
    replay_ref: str,
    *,
    ...
    return {
        ...
        "assistant_notes": [
            "replay_branch_archive: explainability-first; reasoning_v1…v11 inalterados no núcleo.",
            "Soft normalization apenas; sem equivalência forte cross-TCG.",
        ],
        "legality_reasoning": {"status": "assistant_stub", "layer": "replay_branch_archive"},
        "replay_reasoning": {"deterministic_resume": True, "layer": "replay_branch_archive"},
