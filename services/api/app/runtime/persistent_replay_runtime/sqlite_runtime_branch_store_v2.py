...
def sqlite_runtime_branch_store_v2_stub(scope: str, *, storage_path: str | None = None) -> dict[str, Any]:
    return {
        "scope": scope,
        "storage_path": storage_path or "default",
        "assistant_notes": ["sqlite_runtime_branch_store_v2_stub: sprint v6; explainability-first."],
