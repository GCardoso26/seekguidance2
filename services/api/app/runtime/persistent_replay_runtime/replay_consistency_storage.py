"""replay_consistency_storage — contrato incremental (sem DB pesado)."""
...
def replay_consistency_persist_stub(
    replay_ref: str,
    *,
    ...
    return {
        ...
        "assistant_notes": [
            "replay_consistency_storage: explainability-first; reasoning_v1…v11 inalterados no núcleo.",
            "Soft normalization apenas; sem equivalência forte cross-TCG.",
        ],
        "legality_reasoning": {"status": "assistant_stub", "layer": "replay_consistency_storage"},
        "replay_reasoning": {"deterministic_resume": True, "layer": "replay_consistency_storage"},
