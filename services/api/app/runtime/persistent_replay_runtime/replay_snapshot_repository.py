"""replay_snapshot_repository — contrato incremental (sem DB pesado)."""
...
def replay_snapshot_put_stub(
    ...
    *,
    ...
    return {
        ...
        "assistant_notes": [
            "replay_snapshot_repository: explainability-first; reasoning_v1…v11 inalterados no núcleo.",
            "Soft normalization apenas; sem equivalência forte cross-TCG.",
        ],
        "legality_reasoning": {"status": "assistant_stub", "layer": "replay_snapshot_repository"},
        "replay_reasoning": {"deterministic_resume": True, "layer": "replay_snapshot_repository"},
