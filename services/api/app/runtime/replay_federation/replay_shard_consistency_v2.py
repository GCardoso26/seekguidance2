...
def replay_shard_consistency_v2_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["replay_shard_consistency_v2_stub: estabilidade v2; explainability-first."],
