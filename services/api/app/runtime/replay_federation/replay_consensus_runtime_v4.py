...
def replay_consensus_runtime_v4_stub(scope: str, *, storage_path: str | None = None) -> dict[str, Any]:
    return {
        "scope": scope,
        "storage_path": storage_path or "default",
        "assistant_notes": ["replay_consensus_runtime_v4_stub: pre-production v3; explainability-first."],
