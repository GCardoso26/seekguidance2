"""replay_distribution_stability_v2"""
...
def replay_distribution_stability_v2_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["replay_distribution_stability_v2_stub: estabilidade v2; explainability-first."],
