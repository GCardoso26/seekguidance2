...
def federation_node_runtime_v3_stub(scope: str, *, storage_path: str | None = None) -> dict[str, Any]:
    return {
        "scope": scope,
        "storage_path": storage_path or "default",
        "assistant_notes": ["federation_node_runtime_v3_stub: sprint v6; explainability-first."],
