"""replay_determinism_validator_v2"""
...
def replay_determinism_validator_v2_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["replay_determinism_validator_v2_stub: estabilidade v2; explainability-first."],
