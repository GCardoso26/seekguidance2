...
def semantic_replay_divergence_v2_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["semantic_replay_divergence_v2_stub: estabilidade v2; explainability-first."],
