"""replay_consensus_break_detector"""
...
def replay_consensus_break_detector_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["replay_consensus_break_detector_stub: estabilidade v2; explainability-first."],
