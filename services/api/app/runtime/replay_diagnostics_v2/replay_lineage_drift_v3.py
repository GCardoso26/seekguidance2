...
def replay_lineage_drift_v3_stub(scope: str, *, storage_path: str | None = None) -> dict[str, Any]:
    return {
        "scope": scope,
        "storage_path": storage_path or "default",
        "assistant_notes": ["replay_lineage_drift_v3_stub: pilot runtime v4; explainability-first."],
