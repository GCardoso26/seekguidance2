"""replay_branch_instability_runtime"""
...
def replay_branch_instability_runtime_stub(scope: str) -> dict[str, Any]:
    return {
        "scope": scope,
        "assistant_notes": ["replay_branch_instability_runtime_stub: estabilidade v2; explainability-first."],
