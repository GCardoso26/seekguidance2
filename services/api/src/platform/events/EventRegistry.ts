...
const CORE_EVENTS: EventSchemaRegistration[] = [
  ...
  { eventType: "CheckoutExpired.v1", version: 1, description: "Checkout V2 session expired — holds released", frozen: true, payloadKeys: ["sessionId", "buyerId", "paymentIntentId"] },
  ...
  { eventType: "PaymentRefunded.v1", version: 1, description: "Payment refunded after compensate", frozen: true, payloadKeys: ["paymentIntentId", "sessionId"] },
