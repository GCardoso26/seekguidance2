"""replay_integrity_runner — execução judge-grade incremental."""
...
def replay_integrity_runner_stub(
    *,
    ...
    return {
        "assistant_notes": [
            "replay_integrity_runner: validação operacional; juiz humano confirma premissas.",
            "Pipelines V1–V11 preservados; sem motor jurídico automático.",
        ],
        "legality_reasoning": {"refs": len(replay_refs), "layer": "replay_integrity_runner"},
        "replay_reasoning": {"snapshots": len(snapshots or []), "lineage": bool(lineage)},
        "deterministic_alignment": {"token": "rex-replay_integrity_runner"},
