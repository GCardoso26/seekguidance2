# Engineering Process Index

Regras de engenharia pós-fundação (ADR-015). **Não** são novos componentes de runtime.
...
| [Visio consultas](../architecture/visio/README.md) | `.vsdx` + Excel para transpor todas as consultas no MS Visio |
...
Declaração: [ADR-015](../architecture/adr/ADR-015-architecture-freeze-product-first.md)
