...
check "Search Page" "$FRONTEND/loja/busca?q=lightning" 200 "loja/busca"
check "BFF Search" "$FRONTEND/api/catalog/cards/search?q=bolas&game=MTG" 200 "cards"
check "Leaderboard" "$FRONTEND/comunidade/leaderboard" 200 "leaderboard"
check "Checkout" "$FRONTEND/checkout" 200 "checkout"
