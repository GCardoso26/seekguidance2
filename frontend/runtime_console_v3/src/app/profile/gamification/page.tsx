  ...
  return (
    <MobileLayout>
      <div className="container mx-auto px-4 py-8" data-testid="profile-gamification-route">
        <Link href="/perfil" className="text-sm text-muted-foreground hover:text-primary">
          ← Meu perfil
        </Link>
        <h1 className="mt-4 text-2xl font-bold text-foreground">Gamificação</h1>
        <p className="mt-1 text-sm text-muted-foreground">XP, nível e conquistas</p>
        <div className="mt-6">
