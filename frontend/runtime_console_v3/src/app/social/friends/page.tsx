      ...
      <div className="container mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="mt-6 flex gap-2 border-b border-white/10">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium ${
              tab === "friends" ? "border-b-2 border-luxury-gold text-luxury-gold" : "text-luxury-mist"
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium ${
              tab === "pending" ? "border-b-2 border-luxury-gold text-luxury-gold" : "text-luxury-mist"
            }`}
          >
        ...
        {!isLoading && tab === "friends" && (
          <div className="mt-6 space-y-3">
            {friends.length === 0 ? (
              <p className="py-8 text-center text-luxury-mist/70">Você ainda não tem amigos</p>
            ) : (
        ...
        {!isLoading && tab === "pending" && (
          <div className="mt-6 space-y-3">
            {pendingRequests.length === 0 ? (
              <p className="py-8 text-center text-luxury-mist/70">Nenhuma solicitação pendente</p>
            ) : (
