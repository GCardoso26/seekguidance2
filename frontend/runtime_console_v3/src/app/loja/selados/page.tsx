...
/** Canônico de produtos selados (ex-/marketplace/produtos). */
export default function LojaSeladosPage() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/perfil/pedidos" className="rounded-lg border border-border px-3 py-2 text-sm">
              Meus pedidos
            </Link>
