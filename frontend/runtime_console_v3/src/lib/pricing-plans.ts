...
export const PRICING_PLANS: PricingPlan[] = [
  {
    id: "free",
    name: "Jogador Casual",
    subtitle: "Para quem joga de vez em quando",
    iconName: "zap",
    priceMonthly: 0,
    priceAnnual: 0,
    features: [
  ...
  },
  {
    id: "pro",
    name: "Spike",
    subtitle: "Para o jogador competitivo",
    iconName: "crown",
    priceMonthly: 19.9,
    priceAnnual: 199,
    features: [
  ...
  },
  {
    id: "team",
    name: "Equipe",
    subtitle: "Para lojas e equipes",
    iconName: "users",
    priceMonthly: 99.9,
    priceAnnual: 999,
    features: [
      { text: "Tudo do Spike", included: true },
      { text: "Até 5 usuários", included: true, highlight: true },
      { text: "Dashboard compartilhado", included: true },
      { text: "API access (10K req/dia)", included: true, highlight: true },
      { text: "White-label (logo da loja)", included: true },
      { text: "Onboarding dedicado", included: true },
      { text: "SLA 99.9%", included: true },
      { text: "Suporte 24/7", included: true },
    ],
    cta: "Falar com Vendas",
    ctaAction: "mailto:vendas@judgetcg.com.br",
    color: "#8b5cf6",
...
export const PRICING_FAQS = [
  ...
  },
  {
    ...
    a: "Sim, entre em contato pelo plano Equipe.",
  },
  {
    q: "Funciona offline?",
