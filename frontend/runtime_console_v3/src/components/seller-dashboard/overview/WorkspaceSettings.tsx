      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-[71] max-h-[85vh] w-[min(480px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border border-border bg-background p-5">
          ...
          <section className="mb-4 space-y-2">
            <h3 className="text-xs font-semibold uppercase text-muted-foreground">Página inicial</h3>
            <select
          ...
          <section className="mb-4 space-y-2">
            <h3 className="text-xs font-semibold uppercase text-muted-foreground">Densidade das tabelas</h3>
              ...
              {(["comfortable", "compact"] as const).map((d) => (
                <button
                  ...
                  className={`rounded-lg px-3 py-1.5 text-xs ${
                    prefs.tableDensity === d ? "bg-primary text-primary-foreground" : "bg-muted"
                  }`}
                >
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase text-muted-foreground">Widgets do dashboard</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`rounded px-2 py-0.5 text-xs ${pinned ? "bg-primary/30" : "border border-border"}`}
                    >
                      Fixar
                    </button>
                    <button
                      ...
                      className={`rounded px-2 py-0.5 text-xs ${hidden ? "bg-red-500/20" : "border border-border"}`}
                    >
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-xs hover:bg-muted/80"
