  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <button
        ...
        className="inline-flex items-center gap-1 rounded-lg border border-border px-2.5 py-1.5 text-xs hover:bg-muted/80"
      >
      ...
      <div className="flex items-center gap-1">
        <input
          ...
          className="w-28 surface-card rounded-lg px-2 py-1.5 text-xs"
        />
        <button
          type="button"
          onClick={saveFilter}
      ...
      {prefs.savedFilters.length > 0 && (
        <select
          className="surface-card rounded-lg px-2 py-1.5 text-xs"
          defaultValue=""
          onChange={(e) => {
