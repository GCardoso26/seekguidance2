      ...
      <div className="flex gap-2 overflow-x-auto pb-1 sm:flex-wrap sm:overflow-visible">
        {limited.map((s) => (
          <button
            ...
            className={cn(
              "flex min-w-[200px] shrink-0 items-start gap-2 rounded-xl border border-border/50 bg-muted/50 px-3 py-2.5 text-left transition sm:min-w-0 sm:max-w-full",
              "hover:border-[hsl(var(--tcg-accent)/0.35)] hover:bg-muted/50",
            )}
