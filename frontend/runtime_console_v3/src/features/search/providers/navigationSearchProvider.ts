...
const NAV_ITEMS: NavItem[] = [
  ...
  { title: "Meu perfil", href: "/perfil", keywords: ["perfil", "profile", "jogador", "steam"], surfaces: ["marketplace", "public", "judge"] },
  { title: "Decks do perfil", href: "/perfil/decks", keywords: ["meus decks", "perfil decks"], surfaces: ["marketplace", "public"] },
  { title: "Compras", href: "/perfil/compras", keywords: ["compras", "pedidos", "orders"], surfaces: ["marketplace", "public"] },
  { title: "Conquistas", href: "/perfil/conquistas", keywords: ["conquistas", "achievements", "badges"], surfaces: ["marketplace", "public"] },
