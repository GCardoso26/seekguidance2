  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "display-l": ["var(--text-display-l)", { lineHeight: "1.15", letterSpacing: "-0.03em", fontWeight: "700" }],
        "display-m": ["var(--text-display-m)", { lineHeight: "1.2", letterSpacing: "-0.03em", fontWeight: "700" }],
        display: ["var(--text-display)", { lineHeight: "1.2", letterSpacing: "-0.03em", fontWeight: "700" }],
        h1: ["var(--text-h1)", { lineHeight: "1.2", letterSpacing: "-0.025em", fontWeight: "600" }],
        h2: ["var(--text-h2)", { lineHeight: "1.25", letterSpacing: "-0.02em", fontWeight: "600" }],
        ...
        label: ["var(--text-label)", { lineHeight: "1.4", fontWeight: "500", letterSpacing: "0.01em" }],
        hint: ["var(--text-hint)", { lineHeight: "1.4" }],
        overline: ["var(--text-overline)", { lineHeight: "1.4", fontWeight: "600", letterSpacing: "0.08em" }],
        button: ["var(--text-button)", { lineHeight: "1.4", fontWeight: "500" }],
      ...
      spacing: {
        ...
        18: "4.5rem",
        22: "5.5rem",
        "nav-offset": "var(--mobile-nav-offset)",
